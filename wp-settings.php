...
// Load CosmicWord core
require_once(ABSPATH . 'wp-includes/cosmic/cosmicword-core.php');

// Load SEO functionality
require_once(ABSPATH . WPINC . '/seo-functions.php');

//require_once(ABSPATH . WPINC . '/cosmic/cosmic-branding.php');