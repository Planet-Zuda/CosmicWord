...
$options_help .= '<p>' . __( 'You can set the language, and CosmicWord will automatically download and install the translation files (available if your filesystem is writable).' ) . '</p>' .
...
if ( ! is_multisite() ) {
	...
	$sample_tagline = __( 'A spectacular CosmicWord site' );
} else {
...
<tr>
<th scope="row"><label for="siteurl"><?php _e( 'CosmicWord Address (URL)' ); ?></label></th>
...
<p class="description" id="home-description">
		...
		printf(
			/* translators: %s: Documentation URL. */
			__( 'Enter the same address here unless you <a href="%s">want your site home page to be different from your CosmicWord installation directory</a>.' ),
			__( 'https://developer.wordpress.org/advanced-administration/server/wordpress-in-directory/' )
		);
		?>
</p>
