...
function cosmic_add_plugin_button() {
    $screen = get_current_screen();
    if ($screen->id !== 'plugins') {
        return;
    }

    // Add button immediately after the first h1
    add_action('admin_print_footer_scripts', function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (heading) {
                ...
                button.href = '<?php echo esc_url(admin_url('plugin-install.php')); ?>';
                button.className = 'page-title-action';
                button.textContent = '<?php echo esc_js(__('Add New')); ?>';
...
add_action('current_screen', 'cosmic_add_plugin_button');
